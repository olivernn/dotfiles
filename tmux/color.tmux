...
main() {
  ...
  tmux set-option -g pane-border-fg "${dark_purple}"
  ...
  tmux set-option -g status-left-style "fg=${white},bg=${dark_purple},nobold"
  ...
  tmux set-window-option -g window-status-format " #I ${right_alt_sep} #W "
